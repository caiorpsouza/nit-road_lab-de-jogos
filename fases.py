...
phases = [
    {
        ...
        "CarSpawners": [
            ...
            {"lane": 4, "side": "right", "vehicles": ["scooter", "ciclista-sexy"], "velocity": 100},
            {"lane": 5, "side": "left", "vehicles": ["red_car", "yellow_car"], "velocity": 300},
            {"lane": 6, "side": "left", "vehicles": ["red_car"], "velocity": 250},
            {"lane": 7, "side": "right", "vehicles": ["moto", "police_car"], "velocity": 300},
            {"lane": 8, "side": "right", "vehicles": ["police_car"], "velocity": 350},
            {"lane": 11, "side": "left", "vehicles": ["red_car"], "velocity": 400},
            {"lane": 12, "side": "left", "vehicles": ["moto", "blue_car"], "velocity": 200},
            {"lane": 13, "side": "right", "vehicles": ["moto", "yellow_car", "blue_car"], "velocity": 200},
    ...
    },
    {
        ...
        "CarSpawners": [
            ...
            {"lane": 5, "side": "left", "vehicles": ["caminhao", "police_car"], "velocity": 150},
            ...
            {"lane": 13, "side": "left", "vehicles": ["caminhao"], "velocity": 150},
    ...
    {   
        ...
        "CarSpawners": [
            ...
            {"lane": 13, "side": "left", "vehicles": ["ciclista-sexy", "scooter"], "velocity": 100},
        ],
        "buracos": 0,
        "terrains": {
            0: 'ground',
    ...
    },
    {
        ...
        "PropSpawners": [],
        "CarSpawners": [
            {"lane": 8, "side": "left", "vehicles": ["ciclista-sexy", "scooter"], "velocity": 150},
            {"lane": 9, "side": "right", "vehicles": ["bus", "yellow_car"], "velocity": 150},
            {"lane": 10, "side": "left", "vehicles": ["police_car", "moto"], "velocity": 250},
            {"lane": 11, "side": "right", "vehicles": ["red_car"], "velocity": 300},
            {"lane": 12, "side": "left", "vehicles": ["caminhao", "yellow_car", "blue_car"], "velocity": 200},
            {"lane": 13, "side": "right", "vehicles": ["red_car", "bus"], "velocity": 200},
            {"lane": 14, "side": "right", "vehicles": ["ciclista-sexy", "scooter"], "velocity": 250},
        ],
        "buracos": 5,
        "terrains": {
            0: 'ground',
