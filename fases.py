...
phases = [
    ...
    {   
        ...
        "CarSpawners": [
            ...
            {"lane": 13, "side": "left", "vehicles": ["ciclista-sexy"], "velocity": 100},
        ],
        "buracos": 0,
        "terrains": {
            0: 'ground',
    ...
    },
    {
        ...
        "PropSpawners": [],
        "CarSpawners": [
            {"lane": 8, "side": "left", "vehicles": ["ciclista-sexy"], "velocity": 150},
            {"lane": 9, "side": "right", "vehicles": ["bus", "yellow_car"], "velocity": 150},
            {"lane": 10, "side": "left", "vehicles": ["police_car"], "velocity": 150},
            {"lane": 11, "side": "right", "vehicles": ["red_car"], "velocity": 150},
            {"lane": 12, "side": "left", "vehicles": ["red_car", "yellow_car"], "velocity": 200},
            {"lane": 13, "side": "right", "vehicles": ["red_car", "bus"], "velocity": 200},
            {"lane": 14, "side": "right", "vehicles": ["ciclista-sexy"], "velocity": 250},
        ],
        "buracos": 5,
        "terrains": {
            0: 'ground',
